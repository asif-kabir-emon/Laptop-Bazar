...
const Footer = () => {
  return (
    <footer className="flex flex-col md:flex-row justify-between items-center p-10 bg-neutral text-neutral-content">
      <div className="flex flex-col md:flex-row items-center">
        <img src={logo} alt="laptop Bazar logo" className="w-20" />
